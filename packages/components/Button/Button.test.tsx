...
describe("Button.vue", () => {
  ...
  test("basic button", async () => {
    ...
    // class
    expect(buttonElement.classes()).toContain("er-button--primary");

    // slot
    expect(buttonElement.text()).toBe("button content");
  ...
  test("disabled button", async () => {
    ...
    // class
    expect(buttonElement.classes()).toContain("is-disabled");
  ...
  test("loading button", () => {
    ...
    // class
    expect(buttonElement.classes()).toContain("is-loading");
  ...
  it("should has the correct native type attribute when native-type prop is set", () => {
    ...
    expect((buttonElement.element as any).type).toBe("submit");
  });
  ...
  it("should renders the custom tag when tag prop is set", () => {
    ...
    const buttonElement = wrapper.find(".er-button");
    expect(buttonElement.element.tagName.toLowerCase()).toBe("a");
  });
...
describe("ButtonGroup.vue", () => {
  ...
  test("button group size", () => {
    ...
    sizes.forEach((size) => {
      ...
      const buttons = wrapper.findAll(".er-button");
      buttons.forEach((button) => {
        expect(button.classes()).toContain(`er-button--${size}`);
      });
    });
  });
  ...
  test("button group type", () => {
    ...
    types.forEach((type) => {
      ...
      const buttons = wrapper.findAll(".er-button");
      buttons.forEach((button) => {
        expect(button.classes()).toContain(`er-button--${type}`);
      });
    });
  });
