...
(function (n, a) {
  (function (o, i) {
    ...
    function W(e) {
      var t, r;
      return (r = (t = D.exec(e)) === null || t === void 0 ? void 0 : t[0]) !==
        null && r !== void 0
        ? r
        : null;
    }
...
var Be = /^['"]|['"]$/g,
  ...
  B = l((n) => {
    ...
    switch ((typeof o < "u" && (u.raw = o), a)) {
      ...
      case "union":
        return { ...u, name: "union", value: p.map((m) => B(m)) };
      case "instanceOf":
      case "element":
      case "elementType":
      default: {
...
function We(n) {
  return Ne(n) ? Fn(n.__docgenInfo.description) : "";
}
...
function et({ fence: n = "```" } = {}) {
  ...
  return l(function (i) {
    let p = [[]],
      u = !1;
    for (let y of i)
      jn.test(y.tokens.description) && !u
        ? p.push([y])
        : p[p.length - 1].push(y),
...
l(st, "getJoiner");
var Un = l((n) => n && n.startsWith('"') && n.endsWith('"'), "isQuoted");
function it() {
...
l(ct, "compactJoiner");
var Vn = l((n, { tokens: a }, o) => (a.type === "" ? n : o), "lineNo"),
  Dn = l(
    ({ tokens: n }) =>
...
var Yn = l((n, a, o) => {
  ...
  rr = l((n, a) => {
    let o = Ge(n, a);
    return Ye(o) ? (Array.isArray(o) ? Qn(o) : Hn(o)) : [];
  }, "extractComponentProps");
function Ie(n, a, o, i) {
  let p = qn(a.description);
...
const { combineParameters: Zn } = __STORYBOOK_MODULE_PREVIEW_API__;
var ar = l((n) => {
    let {
        component: a,
        argTypes: o,
