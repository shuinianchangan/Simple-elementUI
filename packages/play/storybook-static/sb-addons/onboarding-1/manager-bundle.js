                ...
                function d(N, j) {
                  ...
                  (function (U, z) {
                    ...
                    v(this, "update", function () {
                      ...
                      z &&
                        ((ie.fillStyle = "white"),
                        ie.clearRect(0, 0, _e.width, _e.height)),
                        w.generator.animate()
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
            ...
            var S = s.a.createRef(),
              k = (function (d) {
                ...
                function j(w) {
                  ...
                  return (
                    we(
                      fe((O = N.call.apply(N, [this, w].concat(z)))),
                      "canvas",
                      s.a.createRef(),
                    ),
            ...
            we(k, "defaultProps", se({}, P)),
              we(k, "displayName", "ReactConfetti");
    ...
    function Wn(e, t, n) {
      ...
      return (
        M.undefined(r) || (c = c && l === r),
        M.undefined(o) || (c = c && s === o),
        c
      );
    }
    function Un(e, t, n) {
    ...
    function zn(e) {
      return (t) =>
        M.array(e)
          ? e.some((n) => ae(n, t) || (M.array(t) && on(t)(n)))
          : ae(e, t);
    }
    function lt(e, t) {
    ...
    function _t(e, t) {
      if ([e, t].some(M.nullOrUndefined))
        throw new Error("Missing required parameters");
      if (![e, t].every((n) => M.plainObject(n) || M.array(n)))
      ...
      return {
        ...
        changed: (n, r, i) => {
          try {
            ...
            return [o, a].every(M.array) || [o, a].every(M.plainObject)
              ? !ae(o, a)
              : o !== a;
          } catch {
            return !1;
    ...
    function jr(e, t, n, r) {
      ...
      o.addEventListener(t, n, { passive: !0 }),
        i || jr(yt(o.parentNode), t, n, r),
        r.push(o);
    }
    function ki(e, t, n, r) {
      (n.updateBound = r),
        Mr(e).addEventListener("resize", n.updateBound, { passive: !0 });
      var i = yt(e);
      return (
        jr(i, "scroll", n.updateBound, n.scrollParents),
        (n.scrollElement = i),
        (n.eventsEnabled = !0),
        n
      );
    ...
    function Li() {
      this.state.eventsEnabled &&
        ...
        (this.state = ji(this.reference, this.state)));
    }
    function un(e) {
    ...
    function $a(e, t) {
      return !M.plainObject(e) || !M.array(t)
        ? !1
    ...
    function qe(e, t) {
      ...
      let l = t ?? {},
        c = Ct.default.all([Za, rs(e), l], {
          isMergeableObject: M.plainObject,
        }),
        p = ns(e, c),
    ...
    function hs(e) {
      ...
      return (
        r &&
          ((Q.primary = o ? K : B),
          F &&
            (Q.primary = V("span", null, Q.primary, " (", i + 1, "/", s, ")"))),
        Q.primary &&
          (Q.primary = V(
            "button",
            {
        ...
        V(
          ...
          !m &&
            V(
              ...
              V("div", { style: _.tooltipFooterSpacer }, Q.skip),
              Q.back,
              Q.primary,
            ),
          Q.close,
    ...
    function Gs({ api: e }) {
      let [t, n] = ue(!0),
        ...
        I = ze(() => {
          e.emit(Dn, { step: "6:FinishedOnboarding", type: "telemetry" }),
            ...
            "../../node_modules/prop-types/factoryWithTypeCheckers.js"(e, t) {
              ...
              t.exports = function (c, p) {
                ...
                function Q(S) {
                  ...
                  function k(H, G, d, h, g) {
                    for (var y = H[G], N = 0; N < S.length; N++)
                      if (F(y, S[N])) return null;
                  ...
                  function G(d, h, g, y, N) {
                    for (var j = [], w = 0; w < S.length; w++) {
                      ...
                      U.data &&
                        ...
                        j.push(U.data.expectedType);
                    }
                    var z =
                      j.length > 0
                        ? ", expected one of type [" + j.join(", ") + "]"
                        : "";
                    return new I(
                      "Invalid " +
                        y +
...
Valid keys: ` +
        ...
        x.arrayOf = (e, t) =>
          !x.array(e) && !x.function(t) ? !1 : e.every((n) => t(n));
        ...
        x.generator = (e) =>
          x.iterable(e) && x.function(e.next) && x.function(e.throw);
        x.generatorFunction = Ee("GeneratorFunction");
        x.instanceOf = (e, t) =>
          !e || !t ? !1 : Object.getPrototypeOf(e) === t.prototype;
        x.iterable = (e) =>
          !x.nullOrUndefined(e) && x.function(e[Symbol.iterator]);
        x.map = Ee("Map");
        ...
        x.numericString = (e) =>
          x.string(e) && e.length > 0 && !Number.isNaN(Number(e));
        x.object = (e) =>
          !x.nullOrUndefined(e) && (x.function(e) || typeof e == "object");
            ...
            constructor(e) {
              L(this, "beaconPopper"),
                ...
                L(this, "start", (i) => {
                  ...
                  this.setState({
                    ...this.getNextState(
                      { action: $.START, index: M.number(i) ? i : o },
                      !0,
                    ),
        ...
        (ys = hs),
          ...
          (gs = class extends xe {
            ...
            componentDidUpdate(e) {
              ...
              m("lifecycle", W.INIT, W.READY) &&
                f.update({ lifecycle: lr(u) || F ? W.TOOLTIP : W.BEACON }),
                b("index") &&
                  je({
                    title: `step:${c}`,
                    data: [{ key: "props", value: this.props }],
          ...
          (eo = class extends xe {
            constructor(e) {
              ...
              (this.store = is({ ...e, controlled: r && M.number(i) })),
            ...
            componentDidUpdate(e, t) {
              ...
              if (
                (K &&
                  (pr(p, s) ? m(p) : console.warn("Steps are not valid", p)),
                _("run") && (l ? T(c) : F()),
                B)
              ) {
              ...
              if (v("status", [Y.FINISHED, Y.SKIPPED])) {
                ...
                P("status", [Y.IDLE, Y.READY], Y.RUNNING)
                  ...
                  : (v("status") || v("action", $.RESET)) &&
                    this.callback({ ...Q, type: ve.TOUR_STATUS });
              this.scrollToStep(t),
                R.placement === "center" &&
                  a === Y.RUNNING &&
                  o === W.INIT &&
                ...
                (T = T >= 0 ? T : 0),
                  r === Y.RUNNING &&
                    qa(T, { element: m, duration: a }).then(() => {
                      setTimeout(() => {
                        var _;
                        (_ = this.store.getPopper("tooltip")) == null ||
                          _.instance.update();
                      }, 10);
                    });
              }
